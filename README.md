...
![tests](https://img.shields.io/badge/tests-731-success)
...
> 3.2 GB tuned model **beat a purpose-built 9.5 GB tool-tuned model 0.82 to 0.62**
...
> argued in detail and then refuted with my own data.
